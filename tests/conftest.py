...
def fastapi_app() -> FastAPI:
    ...
    - Includes the same exception handlers as main.py.
    """
    ...
    async def opensearch_service_error_handler(request: Request, exc: OpenSearchServiceError) -> JSONResponse:  # noqa: ARG001
        return JSONResponse(status_code=status.HTTP_502_BAD_GATEWAY, content={"detail": str(exc)})
